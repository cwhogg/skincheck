...
export const metadata: Metadata = {
  title: `Blog — SkinCheck`,
  description: `Latest articles, tips, and guides from SkinCheck.`,
};
  ...
  return (
    <>
      ...
      <main className="flex-1 mx-auto max-w-3xl px-6 py-12">
        ...
        <p className="text-text-secondary mb-8">Latest articles and guides from SkinCheck.</p>
